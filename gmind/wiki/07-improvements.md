...
## V5.0 Phase 4-5 — Frontend UI (следующий)

- TopicNode hover → 4 edge anchors → drag → fantom line → popover
- RelationshipLine rewrite: arrows (forward/bidirectional/undirected), type colors/styles, multi-edge offset, self-loop arc
- RelationshipPanel sidebar
- Filter toolbar, hover-highlight subgraph, cycle warning
